...
var handleEditUser = function handleEditUser(e, username, email, firstName, lastName, id) {
  e.preventDefault(); // console.log(username, email, firstName, lastName, role)
